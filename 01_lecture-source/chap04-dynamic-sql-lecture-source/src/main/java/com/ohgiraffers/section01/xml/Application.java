...
public class Application {
        ...
        do {
            ...
            switch (no) {
                case 1:
                    ...
                    break;
                case 2:
                    menuService.searchMenu(inputSerchCriteria());
                    break;
                case 9:
                    return ;
            }
    ...
    private static List<Integer> generateRandomMenuCodeList(){
        ...
        Collections.sort(list);     // 오름차수순 정렬

        return list;            //발생 난수 생성, 오름차수순
    }
    ...
    private static void trimSubMenu() {
        ...
        do {
            ...
            System.out.println("2. 메뉴 혹은 카테고리 코드로 검색," +
                    " 단 메뉴와 카테고리 둘 다 일치하는 경우도 검색하여, 검색 조건이 없는 경우 전체 검색");
